...
# Apple Credentials
${e_appleValidUserId} =  testios@moolya.com
${e_appleValidPwd} =  Moolya@123
${e_appleUserId} =  testios@moolya.com
${e_applePwd} =  abc@123
# Facebook Credentials
${e_fbValidUserId} =  7019240170
${e_fbValidPwd} =  Test@123
...
${e_invalidFacebookLoginErrorTxt} =  Incorrect password
...
${vf_A_appleSigninBtn} =  xpath=//*[@class='android.widget.Button']
${vf_A_appleContWithAccPage} =  xpath=//*[@text='Continue with account']
${vf_A_appleExistingAcc} =  xpath=//*[@class='android.widget.Button']
#Facebook locators
