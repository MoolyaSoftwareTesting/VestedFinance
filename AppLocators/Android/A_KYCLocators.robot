...
${vf_A_aadhaarFrontImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=4][contains(@content-desc,'Photo taken on ')]
${vf_A_aadhaarBackImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=5][contains(@content-desc,'Photo taken on ')]
