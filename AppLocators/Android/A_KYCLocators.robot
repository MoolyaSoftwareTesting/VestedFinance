...
${vf_A_aadhaarFrontImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=2][contains(@content-desc,'Photo taken on ')]
${vf_A_aadhaarBackImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=1][contains(@content-desc,'Photo taken on ')]
${vf_A_aadhaarFullImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=5][contains(@content-desc,'Photo taken on ')]
${vf_A_panCardImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=4][contains(@content-desc,'Photo taken on ')]
${vf_A_passportImgOnBS} =  xpath=//*[@class='android.view.ViewGroup'][@index=3][contains(@content-desc,'Photo taken on ')]
